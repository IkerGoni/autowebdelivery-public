...
Python 3.10+ · Pydantic v2 · httpx · Jinja2 · Playwright · **1,447 tests passing (CI-enforced on Python 3.10/3.12)** · MIT
...
```bash
python -m pytest tests/ -q            # full suite: 1,447 passed in ~20s
